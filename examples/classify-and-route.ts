/**
 * Multilingual (EN + PT + ES) support classification + persona routing.
...
const RULES: { tag: SupportTag; priority: Priority; any: string[] }[] = [
  { tag: 'payout-issue', priority: 'P1', any: ['payout', 'not paid', 'didnt get paid', 'reward not', 'payment not', 'nao recebi', 'pagamento', 'recompensa nao', 'nao fui pago', 'no me pagaron', 'no he recibido', 'no pagaron'] },
  ...
  { tag: 'transaction-issue', priority: 'P2', any: ['transaction', 'tx', 'failed', 'stuck', 'pending', 'signature', 'transacao', 'falhou', 'travada', 'pendente', 'assinatura', 'transaccion', 'pendiente', 'firma', 'fallo'] },
  { tag: 'wallet-help', priority: 'P2', any: ['wallet', 'phantom', 'solflare', 'connect', 'sign', 'carteira', 'conectar', 'assinar', 'billetera', 'firmar'] },
